...
{{-- Interactive visual contact link --}}
<div
    data-aos="fade-up"
    data-aos-delay="140"
    class=" sticky mt-10 lg:mt-14"
>
    <a
        href="{{ route('contact') }}"
        class="group relative block h-[300px] w-full overflow-hidden bg-newman-navy outline-none sm:h-[360px] lg:h-[420px]"
        aria-label="Contact Newman to plan your private Bali trip"
    >
        {{-- Plain image before hover --}}
        <img
            src="{{ asset('images/img-sticky.png') }}"
            alt="Plan a personal private Bali journey with Newman"
            loading="lazy"
            decoding="async"
            class="absolute inset-0 h-full w-full object-cover object-center transition duration-[1100ms] ease-out motion-reduce:transition-none md:group-hover:scale-[1.035] md:group-hover:brightness-[0.76]"
        >

        {{-- Very soft wash appears only on hover --}}
        <div
            aria-hidden="true"
            class="absolute inset-0 bg-newman-navy/0 opacity-0 transition duration-700 ease-out group-focus-visible:bg-newman-navy/10 group-focus-visible:opacity-100 md:group-hover:bg-newman-navy/10 md:group-hover:opacity-100"
        ></div>

        {{-- Desktop hover panel --}}
        <div
            class="absolute left-1/2 top-1/2 z-10 hidden h-[68%] w-[82%] -translate-x-1/2 -translate-y-[46%] items-center overflow-hidden border border-white/35 bg-white/0 px-8 py-7 opacity-0 shadow-none backdrop-blur-0 transition-all duration-[850ms] ease-out group-focus-visible:-translate-y-1/2 group-focus-visible:bg-white/86 group-focus-visible:opacity-100 group-focus-visible:shadow-2xl group-focus-visible:backdrop-blur-[3px] md:flex md:w-[74%] md:group-hover:-translate-y-1/2 md:group-hover:bg-white/86 md:group-hover:opacity-100 md:group-hover:shadow-2xl md:group-hover:backdrop-blur-[3px] lg:h-[66%] lg:w-[68%] lg:px-12 lg:py-10"
        >
            <div class="grid w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-8 lg:gap-12">
                <div class="min-w-0">
                    <p
                        class="translate-y-3 text-[10px] font-bold uppercase tracking-[0.24em] text-newman-gold opacity-0 transition duration-700 delay-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 md:group-hover:translate-y-0 md:group-hover:opacity-100"
                    >
                        Plan it your way
                    </p>

                    <h3
                        class="mt-3 max-w-2xl translate-y-4 text-3xl font-semibold leading-[1.06] tracking-[-0.045em] text-newman-navy opacity-0 transition duration-700 delay-150 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 md:group-hover:translate-y-0 md:group-hover:opacity-100 lg:text-[48px]"
                    >
                        Have a few Bali places in mind?
                    </h3>

                    <p
                        class="mt-4 max-w-xl translate-y-4 text-sm leading-7 text-newman-navy/68 opacity-0 transition duration-700 delay-200 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 md:group-hover:translate-y-0 md:group-hover:opacity-100 lg:text-[15px]"
                    >
                        Send Newman your destination list, travel date, group
                        size, and pickup area. The route and transport can be
                        arranged around the kind of day you want to have.
                    </p>

                    <p
                        class="mt-5 translate-y-3 text-[10px] font-bold uppercase tracking-[0.18em] text-newman-blue opacity-0 transition duration-700 delay-300 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 md:group-hover:translate-y-0 md:group-hover:opacity-100"
                    >
                ...
                <span
                    aria-hidden="true"
                    class="flex h-16 w-16 shrink-0 scale-75 items-center justify-center rounded-full bg-newman-gold text-newman-navy opacity-0 shadow-lg transition duration-700 delay-200 group-focus-visible:scale-100 group-focus-visible:opacity-100 md:group-hover:translate-x-1 md:group-hover:scale-100 md:group-hover:opacity-100 lg:h-20 lg:w-20"
                >
                    <svg
                        viewBox="0 0 24 24"
                        fill="none"
            ...
            <span
                aria-hidden="true"
                class="absolute bottom-0 left-0 h-[3px] w-0 bg-newman-gold transition-all duration-[900ms] ease-out group-focus-visible:w-full md:group-hover:w-full"
            ></span>
        </div>
    </a>

    {{-- Mobile action outside the image --}}
    <a
        href="{{ route('contact') }}"
        class="flex items-center justify-between border border-newman-navy/10 bg-white px-5 py-4 md:hidden"
    >
        <span>
            <span class="block text-[9px] font-bold uppercase tracking-[0.2em] text-newman-gold">
                Plan it your way
            </span>

            <span class="mt-1 block text-sm font-semibold text-newman-navy">
                Share your Bali trip ideas
            </span>
        </span>

        <span
            aria-hidden="true"
            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-newman-gold text-newman-navy"
        >
            <svg
                viewBox="0 0 24 24"
                fill="none"
